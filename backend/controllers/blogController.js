  ...
  Blog.insertMany([
    {
      ...
      body: {
        ...
        steps: [
          "1. In a large bowl, grate the onion and add the meat and spices. Mix all the ingredients together.",
          "2. Mould the meat in small disks and flatten them on the palm of your hand.",
          "3. Heat the oil in a large frying pan and fry the meat disks on both sides until a caramelised colour on both sides.",
          "4. Add the tomato puree and fry for a minute",
          "5. Add about 100ml of water and the carrots and/or potatoes. Bring to a boil and let it simmer for 30 minutes until the sauce has thickened.",
          "6. Through the end add the lemon juice and let simmer for another 15 minutes.",
